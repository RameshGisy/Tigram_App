...
import 'package:Tigram/SFReports.dart';
...
class SFDashboard extends StatefulWidget {
  ...
  List <String> Dist;
  List <String> Range;
  SFDashboard({this.userId,this.userName,this.userEmail,this.sessionToken,this.userGroup,this.dropdownValue,this.userMobile,this.userProfile,this.userAddress,this.Dist_Range,this.Dist,this.Range});
  @override
  _SFDashboardState createState() => _SFDashboardState(userId,userName,userEmail,sessionToken,userGroup,dropdownValue,userMobile,userProfile,userAddress,Dist_Range,Dist,Range);
}
...
class _SFDashboardState extends State<SFDashboard> {
  ...
  List <String> Dist;
  List <String> Range;
  _SFDashboardState(this.userId,this.userName,this.userEmail,this.sessionToken,this.userGroup,this.dropdownValue,this.userMobile,this.userProfile,this.userAddress,this.Dist_Range,this.Dist,this.Range);
  double Approved=0;
  double Rejected=0;
  double Pending=0;
  void initState()  {
...
//-----------Approved------------------------
  ...
  void PendingApp() async {
    ...
    is_form_two.clear();
    //---------------clear---------------
    final String url = 'http://13.235.67.23:8000/api/auth/sfdPendingListViewApplication';
    Map data = {
...
//-----------Approved-------------
  void ApprovedApp() async {
    ...
    is_form_two1.clear();
    //----------clear-----------
    final String url = 'http://13.235.67.23:8000/api/auth/sfdApprovedListViewApplication';
    Map data = {
      "division":SelectedRange1==null?"":SelectedRange1=="All Division"?"":SelectedRange1,
      "area_range":SelectedRange==null?"":SelectedRange=="All Range"?"":SelectedRange,
    };
                                          ...
                                          sr// Loops through dataColumnText, each iteration assigning the value to element
                                            ...
                                            ((value) => DataRow(
                                              cells: <DataCell>[
                                                ...
                                                DataCell(Text(AssignOfficer(is_form_two[int.parse(value)], assigned_deputy2_by_id[int.parse(value)], assigned_deputy1_by_id[int.parse(value)], log_updated_by_use[int.parse(value)])!=null?AssignOfficer(is_form_two[int.parse(value)], assigned_deputy2_by_id[int.parse(value)], assigned_deputy1_by_id[int.parse(value)], log_updated_by_use[int.parse(value)]):'N/A')),
                                          ...
                                          sr1// Loops through dataColumnText, each iteration assigning the value to element
                                            ...
                                            ((value) => DataRow(
                                              cells: <DataCell>[
                                                ...
                                                DataCell(Text(AssignOfficer(is_form_two1[int.parse(value)], assigned_deputy2_by_id1[int.parse(value)], assigned_deputy1_by_id1[int.parse(value)], log_updated_by_use1[int.parse(value)])!=null?AssignOfficer(is_form_two1[int.parse(value)], assigned_deputy2_by_id1[int.parse(value)], assigned_deputy1_by_id1[int.parse(value)], log_updated_by_use1[int.parse(value)]):'N/A')),
            ...
            child: ListView(
              ...
              children: [
                ...
                ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                          context,MaterialPageRoute(builder: (_) => SFReports(sessionToken:sessionToken,Dist:Dist,Range:Range))//userRange:userRange))
                      );
                    }
                ),
                ListTile(
                    ...
                    onTap: (){
                      Navigator.push(
                          context,MaterialPageRoute(builder: (_) => SFDashboard(
                        sessionToken: sessionToken,
                        userName: userName,
                        userEmail: userEmail,
                        userGroup: userGroup,
